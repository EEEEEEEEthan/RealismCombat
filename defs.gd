...
static var COLOR_NAVY_BLUE: Color = Color("2800ba")
static var COLOR_SAPPHIRE_GLOW: Color = Color("4141ff")
static var COLOR_SAPPHIRE_SKY: Color = Color("5182ff")
static var COLOR_SAPPHIRE_MIST: Color = Color("a2baff")

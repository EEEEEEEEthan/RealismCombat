...
public class DebugShowNodeTreeCommand(ProgramRoot programRoot, IReadOnlyDictionary<string, string> arguments) : Command(programRoot: programRoot, arguments: arguments)
{

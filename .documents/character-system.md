...
- 在选择格挡时，玩家可以选择使用身体部位或装备承受伤害
- 装备的伤害会转移到格挡目标，身体部位会直接承受伤害
...
- 角色的 `reaction` 点数用于格挡或闪避
- 每回合开始时，`reaction` 重置为 1
- 格挡（Block）消耗 1 点反应，选择身体部位或装备承受伤害
- 闪避（Dodge）消耗 1 点反应，打断当前行动并躲开攻击
